...
const RefinerRecipe = [
  ...
  {
    name: "Extreme Polishing",
    output: productIngredient(Product.GLASS, 1),
    inputs: [resourceIngredient(Resource.SILVER, 100)  ],
    device: Device.REFINER
  },
  {
  ...
  },
  {
  ...
  },
   {
    name: "Alchemical Construction",
    output: productIngredient(Product.NANITE_CLUSTERS, 1),
    inputs: [resourceIngredient(Resource.COPRITE, 1) , resourceIngredient(Resource.HEXITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Alchemical Construction",
    output: resourceIngredient(Resource.GOLD, 1),
    inputs: [resourceIngredient(Resource.COPRITE, 1) , resourceIngredient(Resource.RESIDUAL_GOOP, 1) ],
    device: Device.REFINER
  },
  {
    name: "Transmutation",
  ...
  },
  {
    ...
    inputs: [resourceIngredient(Resource.URANIUM, 1) , resourceIngredient(Resource.DI_HYDROGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Sulphur Injection",
    output: resourceIngredient(Resource.SOLANIUM, 1),
    inputs: [resourceIngredient(Resource.SULPHURINE, 1) , resourceIngredient(Resource.DI_HYDROGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Catalyse Radiation",
    output: resourceIngredient(Resource.URANIUM, 1),
    inputs: [resourceIngredient(Resource.RADON, 1) , resourceIngredient(Resource.DI_HYDROGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Organic Fusion",
  ...
  },
  {
    ...
    inputs: [resourceIngredient(Resource.DI_HYDROGEN, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Assisted Decomposition",
    output: resourceIngredient(Resource.COPRITE, 1),
    inputs: [resourceIngredient(Resource.DI_HYDROGEN, 1) , resourceIngredient(Resource.CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Organic Reassembly",
    output: resourceIngredient(Resource.MORDITE, 1),
    inputs: [resourceIngredient(Resource.DI_HYDROGEN, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Carbonise Metal",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 1),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 1) , resourceIngredient(Resource.CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Carbonise Metal",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 2),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Carbonise Metal",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 2),
    inputs: [resourceIngredient(Resource.PURE_FERRITE, 1) , resourceIngredient(Resource.CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Carbonise Metal",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 3),
    inputs: [resourceIngredient(Resource.PURE_FERRITE, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Di-hydrogen Cycling",
    output: resourceIngredient(Resource.DEUTERIUM, 1),
    inputs: [resourceIngredient(Resource.DI_HYDROGEN, 1) , resourceIngredient(Resource.TRITIUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Oxidise Metal",
    output: resourceIngredient(Resource.RUSTED_METAL, 2),
    inputs: [resourceIngredient(Resource.PURE_FERRITE, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Oxidise Metal",
    output: resourceIngredient(Resource.RUSTED_METAL, 1),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Oxygenate Carbon",
    output: resourceIngredient(Resource.CONDENSED_CARBON, 5),
    inputs: [resourceIngredient(Resource.CARBON, 2) , resourceIngredient(Resource.OXYGEN, 2) ],
    device: Device.REFINER
  },
  {
    name: "Oxygenate Carbon",
    output: resourceIngredient(Resource.CONDENSED_CARBON, 6),
    inputs: [resourceIngredient(Resource.CONDENSED_CARBON, 1) , resourceIngredient(Resource.OXYGEN, 2) ],
    device: Device.REFINER
  },
  {
    name: "Oxygenate Sodium",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 1),
    inputs: [resourceIngredient(Resource.SODIUM, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Oxygenate Sodium",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.SODIUM_NITRATE, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Catalyse Carbon",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 1),
    inputs: [resourceIngredient(Resource.CARBON, 1) , resourceIngredient(Resource.SODIUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Catalyse Carbon",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.CONDENSED_CARBON, 1) , resourceIngredient(Resource.SODIUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Advanced Carbon Processing",
    output: resourceIngredient(Resource.DIOXITE, 1),
    inputs: [resourceIngredient(Resource.CARBON, 1) , resourceIngredient(Resource.SODIUM_NITRATE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Advanced Carbon Processing",
    output: resourceIngredient(Resource.DIOXITE, 2),
    inputs: [resourceIngredient(Resource.CONDENSED_CARBON, 1) , resourceIngredient(Resource.SODIUM_NITRATE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Anomaly / Organic Hybridisation",
    output: resourceIngredient(Resource.MORDITE, 1),
    inputs: [resourceIngredient(Resource.CARBON, 1) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Anomaly / Organic Hybridisation",
    output: resourceIngredient(Resource.MORDITE, 2),
    inputs: [resourceIngredient(Resource.CONDENSED_CARBON, 1) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Sentinel Catalysation",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 1),
    inputs: [resourceIngredient(Resource.SODIUM, 1) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Sentinel Catalysation",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 3),
    inputs: [resourceIngredient(Resource.SODIUM_NITRATE, 1) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Runaway Decomposition",
    output: resourceIngredient(Resource.COPRITE, 3),
    inputs: [resourceIngredient(Resource.CARBON, 2) , resourceIngredient(Resource.MORDITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Runaway Decomposition",
    output: resourceIngredient(Resource.COPRITE, 4),
    inputs: [resourceIngredient(Resource.CONDENSED_CARBON, 1) , resourceIngredient(Resource.MORDITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Fertilizer Synthesis ",
    output: resourceIngredient(Resource.MARROW_BULB, 3),
    inputs: [resourceIngredient(Resource.SODIUM, 2) , resourceIngredient(Resource.MORDITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Fertilizer Synthesis ",
    output: resourceIngredient(Resource.MARROW_BULB, 4),
    inputs: [resourceIngredient(Resource.SODIUM_NITRATE, 1) , resourceIngredient(Resource.MORDITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Matter Expansion",
    output: resourceIngredient(Resource.PURE_FERRITE, 3),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 2) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Matter Expansion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 3),
    inputs: [resourceIngredient(Resource.PURE_FERRITE, 2) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Matter Expansion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 4),
    inputs: [resourceIngredient(Resource.MAGNETISED_FERRITE, 3) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Chromatic Expansion",
    output: resourceIngredient(Resource.CADMIUM, 4),
    inputs: [resourceIngredient(Resource.CADMIUM, 1) , resourceIngredient(Resource.CHROMATIC_METAL, 1) ],
    device: Device.REFINER
  },
  {
    name: "Chromatic Expansion",
    output: resourceIngredient(Resource.INDIUM, 4),
    inputs: [resourceIngredient(Resource.INDIUM, 1) , resourceIngredient(Resource.CHROMATIC_METAL, 1) ],
    device: Device.REFINER
  },
  {
    name: "Chromatic Expansion",
    output: resourceIngredient(Resource.EMERIL, 4),
    inputs: [resourceIngredient(Resource.EMERIL, 1) , resourceIngredient(Resource.CHROMATIC_METAL, 1) ],
    device: Device.REFINER
  },
  {
    name: "Chromatic Expansion",
    output: resourceIngredient(Resource.COPPER, 4),
    inputs: [resourceIngredient(Resource.COPPER, 1) , resourceIngredient(Resource.CHROMATIC_METAL, 1) ],
    device: Device.REFINER
  },
  {
    name: "Organic Expansion",
    output: resourceIngredient(Resource.STAR_BULB, 2),
    inputs: [resourceIngredient(Resource.PARAFFINIUM, 1) , resourceIngredient(Resource.STAR_BULB, 1) ],
    device: Device.REFINER
  },
  {
    name: "Organic Expansion",
    output: resourceIngredient(Resource.CACTUS_FLESH, 2),
    inputs: [resourceIngredient(Resource.PYRITE, 1) , resourceIngredient(Resource.CACTUS_FLESH, 1) ],
    device: Device.REFINER
  },
  {
    name: "Organic Expansion",
    output: resourceIngredient(Resource.FUNGAL_MOULD, 2),
    inputs: [resourceIngredient(Resource.AMMONIA, 1) , resourceIngredient(Resource.FUNGAL_MOULD, 1) ],
    device: Device.REFINER
  },
  {
    name: "Organic Expansion",
    output: resourceIngredient(Resource.GAMMA_ROOT, 2),
    inputs: [resourceIngredient(Resource.URANIUM, 1) , resourceIngredient(Resource.GAMMA_ROOT, 1) ],
    device: Device.REFINER
  },
  {
    name: "Organic Expansion",
    output: resourceIngredient(Resource.FROST_CRYSTAL, 2),
    inputs: [resourceIngredient(Resource.DIOXITE, 1) , resourceIngredient(Resource.FROST_CRYSTAL, 1) ],
    device: Device.REFINER
  },
  {
    name: "Organic Expansion",
    output: resourceIngredient(Resource.SOLANIUM, 2),
    inputs: [resourceIngredient(Resource.PHOSPHORUS, 1) , resourceIngredient(Resource.SOLANIUM, 1) ],
    device: Device.REFINER
  },
  {
  ...
  },
  {
    ...
    inputs: [resourceIngredient(Resource.COBALT, 2) , resourceIngredient(Resource.OXYGEN, 2) ],
    device: Device.REFINER
  },
  {
    name: "Efficient Cobalt Ionisation",
    output: resourceIngredient(Resource.IONISED_COBALT, 6),
    inputs: [resourceIngredient(Resource.IONISED_COBALT, 1) , resourceIngredient(Resource.OXYGEN, 2) ],
    device: Device.REFINER
  },
  {
    name: "Organic / Anomaly Synthesis",
    output: resourceIngredient(Resource.GOLD, 1),
    inputs: [resourceIngredient(Resource.MORDITE, 1) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Mineral Alchemy",
    output: resourceIngredient(Resource.PARAFFINIUM, 2),
    inputs: [resourceIngredient(Resource.SILVER, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Mineral Alchemy",
    output: resourceIngredient(Resource.PYRITE, 2),
    inputs: [resourceIngredient(Resource.GOLD, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Mineral Alchemy",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 10),
    inputs: [resourceIngredient(Resource.PLATINUM, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Transfer",
    output: resourceIngredient(Resource.RADON, 1),
    inputs: [resourceIngredient(Resource.SULPHURINE, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Transfer",
    output: resourceIngredient(Resource.NITROGEN, 1),
    inputs: [resourceIngredient(Resource.RADON, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Transfer",
    output: resourceIngredient(Resource.SULPHURINE, 1),
    inputs: [resourceIngredient(Resource.NITROGEN, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Catalysation",
    output: resourceIngredient(Resource.RADON, 1),
    inputs: [resourceIngredient(Resource.SULPHURINE, 1) , resourceIngredient(Resource.CHROMATIC_METAL, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Catalysation",
    output: resourceIngredient(Resource.NITROGEN, 1),
    inputs: [resourceIngredient(Resource.RADON, 1) , resourceIngredient(Resource.CHROMATIC_METAL, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Catalysation",
    output: resourceIngredient(Resource.SULPHURINE, 1),
    inputs: [resourceIngredient(Resource.NITROGEN, 1) , resourceIngredient(Resource.CHROMATIC_METAL, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Catalysation",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 1),
    inputs: [resourceIngredient(Resource.NITROGEN, 1) , resourceIngredient(Resource.SODIUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Catalysation",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.NITROGEN, 1) , resourceIngredient(Resource.SODIUM_NITRATE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Bonded Cobalt Extraction",
    output: resourceIngredient(Resource.IONISED_COBALT, 2),
    inputs: [resourceIngredient(Resource.MARROW_BULB, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
  ...
  },
  {
    ...
    output: resourceIngredient(Resource.COPRITE, 3),
    inputs: [resourceIngredient(Resource.COPRITE, 1) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Pugneum Washing",
    output: resourceIngredient(Resource.IONISED_COBALT, 2),
    inputs: [resourceIngredient(Resource.MARROW_BULB, 1) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Pugneum Washing",
  ...
  },
  {
    name: "Extract Organic Sodium",
    output: resourceIngredient(Resource.SODIUM, 2),
    inputs: [resourceIngredient(Resource.MARROW_BULB, 1) , resourceIngredient(Resource.CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Release Captured Oxygen",
    output: resourceIngredient(Resource.OXYGEN, 2),
    inputs: [resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Feed Microbes",
    output: resourceIngredient(Resource.CONDENSED_CARBON, 2),
    inputs: [resourceIngredient(Resource.COPRITE, 1) , resourceIngredient(Resource.CARBON, 2) ],
    device: Device.REFINER
  },
  {
    name: "Harness Organic Nitrogren",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.MARROW_BULB, 1) , resourceIngredient(Resource.SODIUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Harness Organic Nitrogren",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.SODIUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Feed Microbes",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.COPRITE, 1) , resourceIngredient(Resource.SODIUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Extract Organic Sodium",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.MARROW_BULB, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Release Captured Oxygen",
    output: resourceIngredient(Resource.OXYGEN, 2),
    inputs: [resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Feed Microbes",
    output: resourceIngredient(Resource.CONDENSED_CARBON, 3),
    inputs: [resourceIngredient(Resource.COPRITE, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Harness Organic Nitrogren",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.MARROW_BULB, 1) , resourceIngredient(Resource.SODIUM_NITRATE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Harness Organic Nitrogren",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.SODIUM_NITRATE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Feed Microbes",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.COPRITE, 1) , resourceIngredient(Resource.SODIUM_NITRATE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Ionise Bulbs",
    output: resourceIngredient(Resource.IONISED_COBALT, 2),
    inputs: [resourceIngredient(Resource.MARROW_BULB, 1) , resourceIngredient(Resource.COBALT, 1) ],
    device: Device.REFINER
  },
  {
  ...
  },
  {
    name: "Ionise Bulbs",
    output: resourceIngredient(Resource.IONISED_COBALT, 2),
    inputs: [resourceIngredient(Resource.MARROW_BULB, 1) , resourceIngredient(Resource.IONISED_COBALT, 1) ],
    device: Device.REFINER
  },
  {
    name: "Dissolve Natural Salts",
  ...
  },
  {
    ...
    inputs: [resourceIngredient(Resource.COPRITE, 1) , resourceIngredient(Resource.PUGNEUM, 1) ],
    device: Device.REFINER
  },
  {
    name: "Feed Microbes",
    output: resourceIngredient(Resource.CONDENSED_CARBON, 2),
    inputs: [resourceIngredient(Resource.COPRITE, 1) , resourceIngredient(Resource.MORDITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 4),
    inputs: [resourceIngredient(Resource.INDIUM, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 2),
    inputs: [resourceIngredient(Resource.CADMIUM, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 3),
    inputs: [resourceIngredient(Resource.EMERIL, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 1),
    inputs: [resourceIngredient(Resource.COPPER, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
  ...
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 4),
    inputs: [resourceIngredient(Resource.ACTIVATED_CADMIUM, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 8),
    inputs: [resourceIngredient(Resource.ACTIVATED_INDIUM, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 6),
    inputs: [resourceIngredient(Resource.ACTIVATED_EMERIL, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 2),
    inputs: [resourceIngredient(Resource.ACTIVATED_COPPER, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.CHROMATIC_METAL, 4),
    inputs: [resourceIngredient(Resource.ACTIVATED_CADMIUM, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.CHROMATIC_METAL, 8),
    inputs: [resourceIngredient(Resource.ACTIVATED_INDIUM, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.CHROMATIC_METAL, 6),
    inputs: [resourceIngredient(Resource.ACTIVATED_EMERIL, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Stellar / Metal Fusion",
    output: resourceIngredient(Resource.CHROMATIC_METAL, 2),
    inputs: [resourceIngredient(Resource.ACTIVATED_COPPER, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.STAR_BULB, 1),
    inputs: [resourceIngredient(Resource.PARAFFINIUM, 2) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.CACTUS_FLESH, 1),
    inputs: [resourceIngredient(Resource.PYRITE, 2) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.FUNGAL_MOULD, 1),
    inputs: [resourceIngredient(Resource.AMMONIA, 2) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.GAMMA_ROOT, 1),
    inputs: [resourceIngredient(Resource.URANIUM, 2) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.FROST_CRYSTAL, 1),
    inputs: [resourceIngredient(Resource.DIOXITE, 2) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.SOLANIUM, 1),
    inputs: [resourceIngredient(Resource.PHOSPHORUS, 2) , resourceIngredient(Resource.OXYGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.AMMONIA, 1),
    inputs: [resourceIngredient(Resource.PARAFFINIUM, 2) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.PARAFFINIUM, 1),
    inputs: [resourceIngredient(Resource.PYRITE, 2) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.DIOXITE, 1),
    inputs: [resourceIngredient(Resource.AMMONIA, 2) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.PYRITE, 1),
    inputs: [resourceIngredient(Resource.URANIUM, 2) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.PHOSPHORUS, 1),
    inputs: [resourceIngredient(Resource.DIOXITE, 2) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.URANIUM, 1),
    inputs: [resourceIngredient(Resource.PHOSPHORUS, 2) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.AMMONIA, 1),
    inputs: [resourceIngredient(Resource.PARAFFINIUM, 2) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.PARAFFINIUM, 1),
    inputs: [resourceIngredient(Resource.PYRITE, 2) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.DIOXITE, 1),
    inputs: [resourceIngredient(Resource.AMMONIA, 2) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.PYRITE, 1),
    inputs: [resourceIngredient(Resource.URANIUM, 2) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.PHOSPHORUS, 1),
    inputs: [resourceIngredient(Resource.DIOXITE, 2) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Enviromental Element Transfer",
    output: resourceIngredient(Resource.URANIUM, 1),
    inputs: [resourceIngredient(Resource.PHOSPHORUS, 2) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
  ...
  },
  {
    name: "Floral Titration",
    output: resourceIngredient(Resource.DIOXITE, 1),
    inputs: [resourceIngredient(Resource.FROST_CRYSTAL, 2) , resourceIngredient(Resource.SALT, 1) ],
    device: Device.REFINER
  },
  {
    name: "Floral Titration",
    output: resourceIngredient(Resource.URANIUM, 1),
    inputs: [resourceIngredient(Resource.GAMMA_ROOT, 2) , resourceIngredient(Resource.SALT, 1) ],
    device: Device.REFINER
  },
  {
    name: "Floral Titration",
    output: resourceIngredient(Resource.PYRITE, 1),
    inputs: [resourceIngredient(Resource.CACTUS_FLESH, 2) , resourceIngredient(Resource.SALT, 1) ],
    device: Device.REFINER
  },
  {
    name: "Floral Titration",
    output: resourceIngredient(Resource.PHOSPHORUS, 1),
    inputs: [resourceIngredient(Resource.SOLANIUM, 2) , resourceIngredient(Resource.SALT, 1) ],
    device: Device.REFINER
  },
  {
    name: "Floral Titration",
    output: resourceIngredient(Resource.PARAFFINIUM, 1),
    inputs: [resourceIngredient(Resource.STAR_BULB, 2) , resourceIngredient(Resource.SALT, 1) ],
    device: Device.REFINER
  },
  {
  ...
  },
  {
    ...
    inputs: [resourceIngredient(Resource.COBALT, 50) , resourceIngredient(Resource.IONISED_COBALT, 50) ],
    device: Device.REFINER
  },
  {
  ...
  },
  {
    name: "Loosen Bonds",
    output: resourceIngredient(Resource.PARAFFINIUM, 1),
    inputs: [resourceIngredient(Resource.SULPHURINE, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Metal Enrichment",
    output: resourceIngredient(Resource.URANIUM, 1),
    inputs: [resourceIngredient(Resource.RADON, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Catalysation",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 1),
    inputs: [resourceIngredient(Resource.NITROGEN, 1) , resourceIngredient(Resource.FERRITE_DUST, 1) ],
    device: Device.REFINER
  },
  {
    name: "Loosen Bonds",
    output: resourceIngredient(Resource.PARAFFINIUM, 2),
    inputs: [resourceIngredient(Resource.SULPHURINE, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Metal Enrichment",
    output: resourceIngredient(Resource.URANIUM, 2),
    inputs: [resourceIngredient(Resource.RADON, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Catalysation",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 2),
    inputs: [resourceIngredient(Resource.NITROGEN, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Loosen Bonds",
    output: resourceIngredient(Resource.PARAFFINIUM, 3),
    inputs: [resourceIngredient(Resource.SULPHURINE, 1) , resourceIngredient(Resource.MAGNETISED_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Metal Enrichment",
    output: resourceIngredient(Resource.URANIUM, 3),
    inputs: [resourceIngredient(Resource.RADON, 1) , resourceIngredient(Resource.MAGNETISED_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Gas Catalysation",
    output: resourceIngredient(Resource.SODIUM_NITRATE, 3),
    inputs: [resourceIngredient(Resource.NITROGEN, 1) , resourceIngredient(Resource.MAGNETISED_FERRITE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.FUNGAL_MOULD, 1),
    inputs: [resourceIngredient(Resource.AMMONIA, 1) , resourceIngredient(Resource.NITROGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.FROST_CRYSTAL, 1),
    inputs: [resourceIngredient(Resource.DIOXITE, 1) , resourceIngredient(Resource.RADON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.GAMMA_ROOT, 1),
    inputs: [resourceIngredient(Resource.URANIUM, 1) , resourceIngredient(Resource.RADON, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.CACTUS_FLESH, 1),
    inputs: [resourceIngredient(Resource.PYRITE, 1) , resourceIngredient(Resource.SULPHURINE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.SOLANIUM, 1),
    inputs: [resourceIngredient(Resource.PHOSPHORUS, 1) , resourceIngredient(Resource.SULPHURINE, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.STAR_BULB, 1),
    inputs: [resourceIngredient(Resource.PARAFFINIUM, 1) , resourceIngredient(Resource.NITROGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.MARROW_BULB, 1),
    inputs: [resourceIngredient(Resource.COBALT, 1) , resourceIngredient(Resource.NITROGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.KELP_SAC, 1),
    inputs: [resourceIngredient(Resource.SALT, 1) , resourceIngredient(Resource.NITROGEN, 1) ],
    device: Device.REFINER
  },
  {
    name: "Encourage Growth",
    output: resourceIngredient(Resource.COPRITE, 1),
    inputs: [resourceIngredient(Resource.SULPHURINE, 1) , resourceIngredient(Resource.NITROGEN, 1) ],
    device: Device.REFINER
  },
   {
  ...
  },
  {
    name: "Transmutation",
    output: productIngredient(Product.NANITE_CLUSTERS, 1),
    inputs: [resourceIngredient(Resource.SILVER, 250) , resourceIngredient(Resource.GOLD, 250) , resourceIngredient(Resource.PLATINUM, 250)],
    device: Device.REFINER
  },
  {
    name: "Deep Metal Compression",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 5),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) , resourceIngredient(Resource.SILVER, 1)],
    device: Device.REFINER
  },
  {
    name: "Deep Metal Compression",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 8),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) , resourceIngredient(Resource.GOLD, 1)],
    device: Device.REFINER
  },
  {
    name: "Deep Metal Compression",
    output: resourceIngredient(Resource.MAGNETISED_FERRITE, 12),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 1) , resourceIngredient(Resource.PURE_FERRITE, 1) , resourceIngredient(Resource.PLATINUM, 1)],
    device: Device.REFINER
  },
  {
    name: "Carbon Crystallisation",
  ...
  },
  {
    name: "Cobalt Supercharging",
    output: productIngredient(Product.TETRACOBALT, 1),
    inputs: [resourceIngredient(Resource.COBALT, 40) , resourceIngredient(Resource.IONISED_COBALT, 40) , resourceIngredient(Resource.TRITIUM, 50)],
    device: Device.REFINER
  },
  {
    name: "Chlorine Latticing",
  ...
  },
  {
    ...
    inputs: [resourceIngredient(Resource.FUNGAL_MOULD, 1) , resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1)],
    device: Device.REFINER
  },
  {
    name: "Artificial Photosynthesis",
    output: resourceIngredient(Resource.OXYGEN, 10),
    inputs: [resourceIngredient(Resource.FROST_CRYSTAL, 1) , resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1)],
    device: Device.REFINER
  },
  {
    name: "Artificial Photosynthesis",
    output: resourceIngredient(Resource.OXYGEN, 10),
    inputs: [resourceIngredient(Resource.CACTUS_FLESH, 1) , resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1)],
    device: Device.REFINER
  },
  {
    name: "Artificial Photosynthesis",
    output: resourceIngredient(Resource.OXYGEN, 10),
    inputs: [resourceIngredient(Resource.SOLANIUM, 1) , resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1)],
    device: Device.REFINER
  },
  {
    name: "Artificial Photosynthesis",
    output: resourceIngredient(Resource.OXYGEN, 10),
    inputs: [resourceIngredient(Resource.GAMMA_ROOT, 1) , resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1)],
    device: Device.REFINER
  },
  {
    name: "Artificial Photosynthesis",
    output: resourceIngredient(Resource.OXYGEN, 10),
    inputs: [resourceIngredient(Resource.STAR_BULB, 1) , resourceIngredient(Resource.KELP_SAC, 1) , resourceIngredient(Resource.CONDENSED_CARBON, 1)],
    device: Device.REFINER
  },
  {
    name: "Chromatic Stellar Fusion",
    output: resourceIngredient(Resource.CHROMATIC_METAL, 5),
    inputs: [resourceIngredient(Resource.SILVER, 1) , resourceIngredient(Resource.GOLD, 1) , resourceIngredient(Resource.COPPER, 1)],
    device: Device.REFINER
  },
  {
    name: "Chromatic Stellar Fusion",
    output: resourceIngredient(Resource.CHROMATIC_METAL, 10),
    inputs: [resourceIngredient(Resource.SILVER, 1) , resourceIngredient(Resource.GOLD, 1) , resourceIngredient(Resource.CADMIUM, 1)],
    device: Device.REFINER
  },
  {
    name: "Chromatic Stellar Fusion",
    output: resourceIngredient(Resource.CHROMATIC_METAL, 20),
    inputs: [resourceIngredient(Resource.SILVER, 1) , resourceIngredient(Resource.GOLD, 1) , resourceIngredient(Resource.EMERIL, 1)],
    device: Device.REFINER
  },
  {
    name: "Chromatic Stellar Fusion",
    output: resourceIngredient(Resource.CHROMATIC_METAL, 30),
    inputs: [resourceIngredient(Resource.SILVER, 1) , resourceIngredient(Resource.GOLD, 1) , resourceIngredient(Resource.INDIUM, 1)],
    device: Device.REFINER
  },
  {
    name: "Chromatic Alchemy",
    output: resourceIngredient(Resource.GOLD, 10),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 1) , resourceIngredient(Resource.OXYGEN, 1) , resourceIngredient(Resource.EMERIL, 1)],
    device: Device.REFINER
  },
  {
    name: "Chromatic Alchemy",
    output: resourceIngredient(Resource.PLATINUM, 10),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 1) , resourceIngredient(Resource.OXYGEN, 1) , resourceIngredient(Resource.CHROMATIC_METAL, 250)],
    device: Device.REFINER
  },
  {
    name: "Antimatter Bypass",
    output: productIngredient(Product.WARP_CELL, 1),
    inputs: [resourceIngredient(Resource.CONDENSED_CARBON, 25) , resourceIngredient(Resource.SODIUM, 10) , resourceIngredient(Resource.CHROMATIC_METAL, 250)],
    device: Device.REFINER
  },
  {
    name: "Antimatter Bypass",
    output: productIngredient(Product.WARP_CELL, 1),
    inputs: [resourceIngredient(Resource.CARBON, 50) , resourceIngredient(Resource.SODIUM_NITRATE, 5) , resourceIngredient(Resource.CHROMATIC_METAL, 250)],
    device: Device.REFINER
  },
  {
    name: "Antimatter Bypass",
    output: productIngredient(Product.WARP_CELL, 1),
    inputs: [resourceIngredient(Resource.CONDENSED_CARBON, 25) , resourceIngredient(Resource.SODIUM_NITRATE, 5) , resourceIngredient(Resource.CHROMATIC_METAL, 250)],
    device: Device.REFINER
  },
  {
  ...
  },
  {
    ...
    inputs: [resourceIngredient(Resource.OXYGEN, 10) , resourceIngredient(Resource.CONDENSED_CARBON, 10) , resourceIngredient(Resource.DI_HYDROGEN, 10)],
    device: Device.REFINER
  },
  {
    name: "Di-hydrogen Capture",
    output: productIngredient(Product.STARSHIP_LAUNCH_FUEL, 1),
    inputs: [resourceIngredient(Resource.DI_HYDROGEN, 10) , resourceIngredient(Resource.FERRITE_DUST, 20) , resourceIngredient(Resource.SODIUM_NITRATE, 5)],
    device: Device.REFINER
  },
  {
    name: "Di-hydrogen Capture",
    output: productIngredient(Product.STARSHIP_LAUNCH_FUEL, 1),
    inputs: [resourceIngredient(Resource.DI_HYDROGEN, 10) , resourceIngredient(Resource.PURE_FERRITE, 20) , resourceIngredient(Resource.SODIUM, 10)],
    device: Device.REFINER
  },
  {
    name: "Di-hydrogen Capture",
    output: productIngredient(Product.STARSHIP_LAUNCH_FUEL, 1),
    inputs: [resourceIngredient(Resource.DI_HYDROGEN, 10) , resourceIngredient(Resource.MAGNETISED_FERRITE, 10) , resourceIngredient(Resource.SODIUM_NITRATE, 5)],
    device: Device.REFINER
  },
  {
    name: "Ion Capture",
    output: productIngredient(Product.ION_BATTERY, 1),
    inputs: [resourceIngredient(Resource.FERRITE_DUST, 10) , resourceIngredient(Resource.SILVER, 10) , resourceIngredient(Resource.SODIUM, 10)],
    device: Device.REFINER
  },
  {
    name: "Advanced Ion Capture",
    output: productIngredient(Product.ADVANCED_ION_BATTERY, 1),
    inputs: [resourceIngredient(Resource.PURE_FERRITE, 10) , resourceIngredient(Resource.SILVER, 10) , resourceIngredient(Resource.SODIUM_NITRATE, 10)],
    device: Device.REFINER
  },
  {
